#!/usr/bin/env bash
#
# Prune old NovaFinder release artifacts from the R2 (S3-compatible) bucket,
...
#   NovaFinder-<ver>-mac-<arch>.dmg                  (macOS installer)
#   NovaFinder-<ver>-mac-<arch>.zip[.blockmap]       (macOS zip — used by the updater)
